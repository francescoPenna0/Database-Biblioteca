...
<html>
    ...
    <body>
        ...
        <h2>Registrazione di un Prestito</h2>

        <p>Compila il modulo qui sotto per registrare un Prestito nel Database</p>

        <form action="Inserimento_prestito.php" method="POST">
